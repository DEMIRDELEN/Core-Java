...
public class C02_MdaTumElementleriYazdirma {
    public static void main(String[] args) {
        ...
        //verilen bir multi dimensional array in tum elementlerini yazdiran bir metod hazirlayalım
    ...
    public static void elementleriYazdir(int[][] sayilar) {
        ...
        for (int i = 0; i < sayilar.length ; i++) { //i=0,1,2 degerleri alacak
            ...
            for (int j = 0; j <sayilar[i].length; j++) { // inner array lerin uzunluguna kadar gidecek
