...
public class ManavIslemler {
    ...
    * 2. Adım: Kullanıcının ürün nosuna göre listeden
    * ürün seçmesini isteyiniz.
    * 3. Adım: Kaç kg satın almak istediğini
    * ve urun kodunu  aliniz.
    * 4. Adım: Alınacak bu ürünü sepete ekleyiniz
    * 5. Sepeti yazdırınız.
    * 6. Eğer devam etmek istiyorsa yeniden ürün
    * seçme kısmına yönlendiriniz.
